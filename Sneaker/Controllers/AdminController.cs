...
namespace Sneaker.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult XacNhanXoa3(int id)
        {
            ...
            // Kiểm tra xem đơn đặt hàng có chi tiết đặt hàng hay không
            bool hasChiTietDatHang = db.ChiTietDatHangs.Any(n => n.MaDonHang == id);

            if (hasChiTietDatHang)
            {
                // Nếu có chi tiết đặt hàng, không cho phép xóa và hiển thị thông báo lỗi
                ViewBag.ErrorMessage = "Không thể xóa đơn đặt hàng này vì có chi tiết đặt hàng liên quan.";
                return View("Error");
            }
